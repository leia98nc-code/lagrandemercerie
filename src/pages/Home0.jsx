...
export default function Home() {
          ...
          <div style={{
            ...
            <div>
              ...
              <p style={{
                ...
                Votre mercerie du Quartier latin à Nouméa.<br />
  ...
  <Link to="/contact" style={{
    ...
    fontFamily: 'var(--font-corps)',
    fontWeight: 500,
    borderBottom: '1px solid var(--rose-poudre)',
    paddingBottom: '1px',
  ...
  >
    Nous trouver →
            ...
            <div style={{
              ...
              overflow: 'hidden',
              boxShadow: '0 12px 40px rgba(160,48,74,0.15)',
              aspectRatio: '4/3',
              marginTop: '2rem',
              background: 'var(--blanc)',
              display: 'flex',
              ...
              <Link key={nom} to={lien} style={{ textDecoration: 'none' }}>
                <div style={{
                  ...
                  onMouseEnter={e => {
                    ...
                    e.currentTarget.style.boxShadow = '0 8px 24px rgba(160,48,74,0.22)'
                  }}
                  onMouseLeave={e => {
                ...
                >
                  <img src={photo} alt={nom} style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
                  <div style={{
      ...
      {/* ── Réassurance ── fond burgundy */}
      <section style={{ padding: '2.5rem 0', background: 'var(--rose-profond)' }}>
        <div className="container">
          <div style={{
            display: 'grid',
            ...
            {[
              ...
              <div key={titre} style={{
                ...
                <div>
                  <p style={{ fontWeight: 700, fontSize: '0.85rem', color: 'white', marginBottom: '0.15rem' }}>{titre}</p>
                  <p style={{ fontSize: '0.76rem', color: 'rgba(255,255,255,0.8)', lineHeight: 1.5 }}>{texte}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      {/* ── Newsletter ── gradient blush → burgundy */}
      <section style={{
        padding: '4rem 0',
